...
namespace OnlineShopApp.Controllers
{
    public class EmpTypesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,TypeName,CreatedBy,CreatedAt,UpdatedBy,UpdatedAt")] EmpType empType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,TypeName,CreatedBy,CreatedAt,UpdatedBy,UpdatedAt")] EmpType empType)
        {
            if (id != empType.Id)
            {
                return NotFound();

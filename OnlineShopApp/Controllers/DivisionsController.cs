...
namespace OnlineShopApp.Controllers
{
    public class DivisionsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,CreatedBy,CreatedAt,UpdatedBy,UpdatedAt")] Division division)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,CreatedBy,CreatedAt,UpdatedBy,UpdatedAt")] Division division)
        {
            if (id != division.Id)
            {
                return NotFound();
